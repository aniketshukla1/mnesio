...
//!
//! Mirrors the boot sequence in `mnesio-server/src/main.rs` but stays
...
use mnesio_core::{Embedder, EventLog};
...
pub struct AppContext {
    ...
    pub synthesizer: Arc<dyn mnesio_core::Synthesizer>,
}
