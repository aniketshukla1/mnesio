...
//! and the one mnesio was missing: storing turns verbatim is a "junk
...
//!   `mnesio-procedural` separates the pure compiler from the worker.
...
pub enum ConsolidationAction {
    ...
    /// [`mnesio_core::Memory`] carrying `content` **using `id`** as its
