//! # mnesio-kv — gated KV cartridges (Phase 12, the moonshot)
//!
...
//!
//! mnesio's move is to treat a cartridge as **just another materialized view of
...
//!    passes [`mnesio_core::EvalReport::is_committable`] (Hard Rule #1). A blob
...
//!    *key-sealed* memories ([`mnesio_privacy::Keyring`]). Forget a subject
