//! # mnesio-exchange — certified skill exchange (Phase 13)
//!
//! A gated [`mnesio_core::PolicyArtifact`] is a portable *unit of certified
...
//!    - apply the importer's **own** [`mnesio_procedural::EvalGates`]; the skill
