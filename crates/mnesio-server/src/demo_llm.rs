...
//!
//! [`mnesio_llm::FakeLlmClient`] is deterministic but returns identical
...
//!   in the dashboard.
//!
//! For *real* enrichment quality, set `MNESIO_EVOLVE_LLM=ollama` and
//! point [`OllamaLlmClient`][mnesio_llm::OllamaLlmClient] at a running
//! local model.
...
/// `mnesio_evolve::prompts::note_construction` asks for.
