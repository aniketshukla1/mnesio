...
pub trait Probe: Send + Sync {
    async fn check(&self, memory: MemoryRef, content: &str) -> Result<ProbeVerdict, MnemeError>;
}
...
impl Probe for FakeProbe {
    async fn check(&self, _memory: MemoryRef, content: &str) -> Result<ProbeVerdict, MnemeError> {
