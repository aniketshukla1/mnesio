"""mneme — self-improving long-term memory layer for AI agents.

Three primitives:

- ``Client(data_dir, embedder="mock")`` — open / create a mneme store.
...
from ._mneme import Client, SearchResult, SearchHit, MnemeError

__all__ = ["Client", "SearchResult", "SearchHit", "MnemeError"]
