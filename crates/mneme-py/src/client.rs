...
use mneme_core::entity::{JudgeSource, Memory, Outcome, Provenance};
...
pub struct InnerClient {
    ...
    synthesizer: Arc<dyn mneme_core::Synthesizer>,
}
...
impl InnerClient {
    /// Open or create a mneme store at `data_dir`. `embedder` is
