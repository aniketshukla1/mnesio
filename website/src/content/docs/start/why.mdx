---
title: Why mnesio
description: What makes mnesio different from storage-shaped agent-memory systems — the procedural wedge behind a non-bypassable safety gate.
---
...
mnesio is not a place to put facts. It is:
...
Next: [Getting started](/start/getting-started/) to build mnesio from source, or
